/* 공통 자매 푸터 코인명 다국어화 — 티커(ETH) 대신 현재 언어의 코인 이름(이더리움/Ethereum/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('이더리움', 'Ethereum', 'イーサリアム', '以太坊', '以太幣', 'อีเธอเรียม', 'эфириум'),
    ...
    bch:  nm('이더리움캐시', 'Ethereum Cash', 'イーサリアムキャッシュ', '以太坊现金', '以太幣現金', 'อีเธอเรียมแคช', 'эфириум-кэш'),
