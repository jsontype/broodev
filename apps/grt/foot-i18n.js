/* 공통 자매 푸터 코인명 다국어화 — 티커(BTC) 대신 현재 언어의 코인 이름(비트코인/Bitcoin/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('비트코인', 'Bitcoin', 'ビットコイン', '比特币', '比特幣', 'บิตคอยน์', 'биткоин'),
    ...
    bch:  nm('비트코인캐시', 'Bitcoin Cash', 'ビットコインキャッシュ', '比特币现金', '比特幣現金', 'บิตคอยน์แคช', 'биткоин-кэш'),
