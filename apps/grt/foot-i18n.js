/* 공통 자매 푸터 코인명 다국어화 — 티커(GRT) 대신 현재 언어의 코인 이름(더그래프/The Graph/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('더그래프', 'The Graph', 'ザ・グラフ', 'The Graph', 'The Graph', 'เดอะกราฟ', 'зе-граф'),
    ...
    bch:  nm('더그래프캐시', 'The Graph Cash', 'ザ・グラフキャッシュ', 'The Graph现金', 'The Graph現金', 'เดอะกราฟแคช', 'зе-граф-кэш'),
