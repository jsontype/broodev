/* 공통 자매 푸터 코인명 다국어화 — 티커(DOT) 대신 현재 언어의 코인 이름(폴카닷/Polkadot/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('폴카닷', 'Polkadot', 'ポルカドット', '波卡', '波卡', 'โพลคาดอต', 'полкадот'),
    ...
    bch:  nm('폴카닷캐시', 'Polkadot Cash', 'ポルカドットキャッシュ', '波卡现金', '波卡現金', 'โพลคาดอตแคช', 'полкадот-кэш'),
