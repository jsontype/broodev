/* 공통 자매 푸터 코인명 다국어화 — 티커(XLM) 대신 현재 언어의 코인 이름(스텔라루멘/Stellar/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('스텔라루멘', 'Stellar', 'ステラルーメン', '恒星币', '恆星幣', 'สเตลลาร์', 'стеллар'),
    ...
    bch:  nm('스텔라루멘캐시', 'Stellar Cash', 'ステラルーメンキャッシュ', '恒星币现金', '恆星幣現金', 'สเตลลาร์แคช', 'стеллар-кэш'),
