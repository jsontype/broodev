/* 공통 자매 푸터 코인명 다국어화 — 티커(BCH) 대신 현재 언어의 코인 이름(비트코인캐시/Bitcoin Cash/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('비트코인캐시', 'Bitcoin Cash', 'ビットコインキャッシュ', '比特币现金', '比特幣現金', 'บิตคอยน์แคช', 'биткоин-кэш'),
    ...
    bch:  nm('비트코인캐시캐시', 'Bitcoin Cash Cash', 'ビットコインキャッシュキャッシュ', '比特币现金现金', '比特幣現金現金', 'บิตคอยน์แคชแคช', 'биткоин-кэш-кэш'),
