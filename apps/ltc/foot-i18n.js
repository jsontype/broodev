/* 공통 자매 푸터 코인명 다국어화 — 티커(LTC) 대신 현재 언어의 코인 이름(라이트코인/Litecoin/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('라이트코인', 'Litecoin', 'ライトコイン', '莱特币', '萊特幣', 'ไลต์คอยน์', 'лайткоин'),
    ...
    bch:  nm('라이트코인캐시', 'Litecoin Cash', 'ライトコインキャッシュ', '莱特币现金', '萊特幣現金', 'ไลต์คอยน์แคช', 'лайткоин-кэш'),
