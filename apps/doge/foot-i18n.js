/* 공통 자매 푸터 코인명 다국어화 — 티커(DOGE) 대신 현재 언어의 코인 이름(도지코인/Dogecoin/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('도지코인', 'Dogecoin', 'ドージコイン', '狗狗币', '狗狗幣', 'ดอจคอยน์', 'догикоин'),
    ...
    bch:  nm('도지코인캐시', 'Dogecoin Cash', 'ドージコインキャッシュ', '狗狗币现金', '狗狗幣現金', 'ดอจคอยน์แคช', 'догикоин-кэш'),
