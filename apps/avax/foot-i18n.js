/* 공통 자매 푸터 코인명 다국어화 — 티커(AVAX) 대신 현재 언어의 코인 이름(아발란체/Avalanche/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('아발란체', 'Avalanche', 'アバランチ', '雪崩币', '雪崩幣', 'อาวาแลนช์', 'аваланч'),
    ...
    bch:  nm('아발란체캐시', 'Avalanche Cash', 'アバランチキャッシュ', '雪崩币现金', '雪崩幣現金', 'อาวาแลนช์แคช', 'аваланч-кэш'),
