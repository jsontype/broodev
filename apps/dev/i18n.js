...
(function () {
  ...
  var KO = {
    ...
    apps: {
      ...
      cat: { crypto: '투자', learn: '학습', info: '국가정보' },
      sigTpl: '{name} 공포·탐욕 지수와 6개 지표(RSI·MACD·마이어 배수·낙폭·이동평균)를 합성한 매수 타이밍 점수(0~100).',
      sigAllDesc: '비트코인·이더리움 등 15종 코인의 공포·탐욕 지수와 6개 지표(RSI·MACD·마이어 배수·낙폭·이동평균)를 합성한 매수 타이밍 점수(0~100). 앱 안의 코인 선택기로 전환.',
      ...
      philippinesDesc: '필리핀 태풍 시그널 1~5호 행동 가이드, 실시간 환율·OFW 송금 비용 계산기, SSS·PhilHealth 등 정부 포털, 통신사 USSD 코드를 한 화면에.',
      caribbeanDesc: '자메이카·트리니다드·바베이도스·바하마의 섬별 허리케인 대비 플레이북, 정전 신고 안내, 실시간 환율·송금 계산기, 시험·여권 포털을 한 화면에.',
      pakistanDesc: '파키스탄 배전사(DISCO)별 로드셰딩 안내, 교육위원회 20여 곳의 시험 결과 확인법, NADRA 신분증 수수료표, 실시간 환율·송금 계산기, 통신사 USSD 코드.',
      bangladeshDesc: '방글라데시 사이클론 신호 1~11호 해설, 홍수 경보(FFWC) 안내, 로드셰딩, SSC·HSC 결과 확인법(SMS 포함), 실시간 환율·송금 계산기를 한 화면에.',
      nepalDesc: '비크람력(BS)↔서기 날짜 변환기, EPS 한국 취업 가이드, 실시간 환율·송금 계산기, 카트만두·트레킹 지역 날씨와 지진 정보를 한 화면에.',
      srilankaDesc: '스리랑카 계획 정전(CEB) 그룹 안내, 철도 노선별 가이드, A/L Z-score 제도 해설, 실시간 환율·송금 계산기, 시험·신분증 포털을 한 화면에.',
      stansDesc: '우즈베크·키르기스·타지크 노동자를 위한 러시아 파텐트(노동허가) 단계별 가이드, RUB 송금 실효비용 계산기, 겨울 전력제한 안내, USSD 코드 (러시아어 UI).',
      pacificDesc: '피지·사모아·통가·바누아투의 사이클론 대비 가이드, 파고·조석 정보, 호주 PALM·뉴질랜드 RSE 계절노동 안내, 송금 실효비용 계산기를 한 화면에.',
      nunavutDesc: '캐나다 누나부트 10개 커뮤니티의 날씨·블리자드·오로라 전망, 실리프트(연례 해상 보급) 안내, 수렵 시즌·쿼터 참조표, 이눅티투트 음절문자 도구.',
      mongoliaDesc: '울란바토르 구별 실시간 초미세먼지(PM2.5), 아이막별 날씨·체감온도, 조드(한파 재해)·가축 지수보험(IBLI) 가이드, 실시간 환율을 한 화면에.',
