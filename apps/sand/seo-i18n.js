...
(function () {
  var SEO = {
    ko: {
      ...
      intro: '샌드박스 공포지수(공포·탐욕 지수, Fear & Greed Index)를 포함한 6개 실시간 지표를 합성해 “지금이 매수 타이밍인가?”를 0~100 점수로 보여주는 무료 대시보드입니다. 설치 없이 브라우저에서 바로 실행되며 13개 언어를 지원합니다.',
      whatIsH: '샌드박스 공포지수란?',
    ...
    en: {
      ...
      intro: 'A free dashboard that synthesizes 6 real-time indicators — including the The Sandbox Fear & Greed Index — into a 0–100 “is now a good time to buy?” score. Runs in your browser with no install, in 13 languages.',
    ...
    ja: {
      ...
      intro: 'サンドボックスの恐怖・強欲指数（Fear & Greed Index）を含む6つのリアルタイム指標を合成し、「今が買い時か？」を0〜100のスコアで示す無料ダッシュボードです。インストール不要でブラウザから即実行、13言語対応。',
    ...
    zh: {
      ...
      intro: '一个免费仪表板，将包括沙盒恐惧与贪婪指数（Fear & Greed Index）在内的6个实时指标合成为0–100的“现在是买入时机吗？”评分。无需安装，浏览器即开即用，支持13种语言。',
      whatIsH: '什么是沙盒恐惧指数？',
    ...
    'zh-Hant': {
      ...
      intro: '一個免費儀表板，將包括沙盒恐懼與貪婪指數（Fear & Greed Index）在內的6個即時指標合成為0–100的「現在是買入時機嗎？」評分。免安裝、瀏覽器即開即用，支援13種語言。',
      whatIsH: '什麼是沙盒恐懼指數？',
    ...
    es: {
      ...
      intro: 'Un panel gratuito que sintetiza 6 indicadores en tiempo real —incluido el índice de miedo y codicia de The Sandbox— en una puntuación de 0 a 100 sobre «¿es buen momento para comprar?». Funciona en el navegador sin instalación, en 13 idiomas.',
    ...
    fr: {
      ...
      intro: 'Un tableau de bord gratuit qui synthétise 6 indicateurs en temps réel — dont l’indice de peur et d’avidité The Sandbox — en un score de 0 à 100 « est-ce le bon moment pour acheter ? ». Fonctionne dans le navigateur sans installation, en 13 langues.',
    ...
    de: {
      ...
      intro: 'Ein kostenloses Dashboard, das 6 Echtzeit-Indikatoren — inkl. The Sandbox Angst- & Gier-Index — zu einem 0–100-Score „Ist jetzt ein guter Kaufzeitpunkt?“ zusammenführt. Läuft im Browser ohne Installation, in 13 Sprachen.',
    ...
    it: {
      ...
      intro: 'Una dashboard gratuita che sintetizza 6 indicatori in tempo reale — incluso l’indice di paura e avidità di The Sandbox — in un punteggio 0–100 «è il momento giusto per comprare?». Funziona nel browser senza installazione, in 13 lingue.',
    ...
    pt: {
      ...
      intro: 'Um painel gratuito que sintetiza 6 indicadores em tempo real — incluindo o índice de medo e ganância do The Sandbox — numa pontuação de 0 a 100 «é uma boa hora para comprar?». Roda no navegador sem instalação, em 13 idiomas.',
    ...
    ru: {
      ...
      intro: 'Бесплатная панель, которая объединяет 6 индикаторов в реальном времени — включая индекс страха и жадности сэндбокса — в оценку от 0 до 100 «подходящее ли сейчас время для покупки?». Работает в браузере без установки, на 13 языках.',
    ...
    nl: {
      ...
      intro: 'Een gratis dashboard dat 6 realtime indicatoren — inclusief de The Sandbox Angst- & Hebzucht-index — samenvoegt tot een score van 0–100 voor «is het nu een goed moment om te kopen?». Draait in de browser zonder installatie, in 13 talen.',
    ...
    th: {
      ...
      intro: 'แดชบอร์ดฟรีที่รวม 6 ตัวชี้วัดแบบเรียลไทม์ — รวมถึงดัชนีความกลัวและความโลภของแซนด์บ็อกซ์ — เป็นคะแนน 0–100 ว่า “ตอนนี้เป็นจังหวะซื้อหรือไม่?” ใช้งานในเบราว์เซอร์ได้ทันที ไม่ต้องติดตั้ง รองรับ 13 ภาษา',
