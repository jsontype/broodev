/* 공통 자매 푸터 코인명 다국어화 — 티커(SAND) 대신 현재 언어의 코인 이름(샌드박스/The Sandbox/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('샌드박스', 'The Sandbox', 'サンドボックス', '沙盒', '沙盒', 'แซนด์บ็อกซ์', 'сэндбокс'),
    ...
    bch:  nm('샌드박스캐시', 'The Sandbox Cash', 'サンドボックスキャッシュ', '沙盒现金', '沙盒現金', 'แซนด์บ็อกซ์แคช', 'сэндбокс-кэш'),
