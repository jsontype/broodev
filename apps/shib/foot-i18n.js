/* 공통 자매 푸터 코인명 다국어화 — 티커(SHIB) 대신 현재 언어의 코인 이름(시바이누/Shiba Inu/…) 표시.
...
(function () {
  ...
  var NAMES = {
    btc:  nm('시바이누', 'Shiba Inu', 'シバイヌ', '柴犬币', '柴犬幣', 'ชิบะอินุ', 'шиба-ину'),
    ...
    bch:  nm('시바이누캐시', 'Shiba Inu Cash', 'シバイヌキャッシュ', '柴犬币现金', '柴犬幣現金', 'ชิบะอินุแคช', 'шиба-ину-кэш'),
